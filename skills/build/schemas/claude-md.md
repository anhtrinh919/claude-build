...
> This is the project's `CLAUDE.md`. Claude Code auto-loads it at the start of every session in this directory. It is the **index + operating context** for the project. It does NOT duplicate the living docs — it points to them. On any conflict, the doc it points to wins.
